...
- **基于 Unity 引擎**
- **2D 光照与 3D 模型支持**
- **完全开源**  （基于 **GNU GPLv3** 开源协议，详见[**使用许可、商业用途与版权须知**](https://github.com/Bli-AIk/Undertale-Changer-Template/blob/main/LICENSE_MONETIZATION_AND_COPYRIGHT_NOTICE_zh-CN.md)）
- **支持社区扩展**
- **本地化支持完善**
